...
def Online_train_classifierLM_incremental(args_dict):
    ...
    if order == 1:
        # order 1: recognize the MI class online without online updating the model 
    ...
    if order == 2:
        ...
        if (trial + 1) % 6 == 0:
            ...
            for label in unique_labels:
                ...
                target_indices = indices[windows_num:]
        ...
        for epoch in trange(_n_epoch_online, desc='1-fold cross validation'):
           ...
           """
            ...
            if (trial + 1) % 6 == 0:
                ...
                #if accuracy_per_class[-1] > 0.33:
                    is_best = val_accuracy >= best_val_accuracy
            else:
                is_best = val_accuracy >= best_val_accuracy
            """

            is_best =  accuracy_per_class[0] > 0.33 and accuracy_per_class[-1] > 0.33 and accuracy_per_class[-2] > 0.33
