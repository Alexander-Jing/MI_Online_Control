...
python Offline_train_EEGNet.py --seed 42 --gpu_idx 0 --sub_name 'Jyt' --folder_path ${PYTHONPATH}/DataCollected_Jyt --windows_num 149 --proportion 0.8 --result_save_rootdir ${PYTHONPATH}/Offline_experiments --restore_file 'lr1.0_dropout0.25' --n_epoch 64
